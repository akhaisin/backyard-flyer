...
export function quadW1CombinedConfig(overrides?: Partial<QuadConsts>): ModelConfig {
  ...
  return {
    ...
    blocksDiagram: [
      ...
      { from: 'planner_w1a', to: 'navigator_a', label: 'carrot' },
      { from: 'navigator_a', to: 'world_a',     label: 'A stack' },
      { from: 'lifecycle',  to: 'mission_b',    label: 'K'      },
      { from: 'wind',       to: 'world_b',      label: 'force'  },
      { from: 'mission_b',  to: 'planner_w1b',  label: 'step'   },
      { from: 'planner_w1b', to: 'navigator_b', label: 'carrot' },
      { from: 'navigator_b', to: 'world_b',     label: 'B stack' },
    ],
    charts: [
      {
