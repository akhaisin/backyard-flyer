...
// Build the gate frames from the route: pos → center, label W1..Wn (labels are
// a vis concern, not carried on the mission bus).
const WINDOWS: WindowDef[] = W1A_ROUTE.map((s, i) => ({
  center: s.pos,
