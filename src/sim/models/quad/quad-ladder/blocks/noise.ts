...
const POS_STD     = 0.001;   // m   — GPS horizontal / vertical noise
const VEL_STD     = 0.001;   // m/s — velocity estimate noise
const ATT_STD     = 0.00001;  // rad — IMU attitude noise (~0.3°)
const ANG_VEL_STD = 0.0005;   // rad/s — gyro noise
